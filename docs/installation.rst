...
This is the preferred method to install Geneviz, as it will always install the most recent stable release. 
...
The sources for Geneviz can be downloaded from the `Github repo`_.
